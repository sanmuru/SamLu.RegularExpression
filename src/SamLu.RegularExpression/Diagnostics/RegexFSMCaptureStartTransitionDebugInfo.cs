...
namespace SamLu.RegularExpression.Diagnostics
{
    ...
    public class RegexFSMCaptureStartTransitionDebugInfo<T> : RegexFSMFunctionalTransitionDebugInfoBase<T, RegexFSMCaptureStartTransition<T>>
    {
        /// <summary>
        ...
        /// <summary>
        /// 使用规范参数列表初始化 <see cref="RegexFSMCaptureStartTransitionDebugInfo{T}"/> 类的新实例。
        /// </summary>
        /// <param name="functionalTransition">正则表达式构造的有限状态机的功能转换。</param>
        /// <param name="args">获取调试信息的参数列表。</param>
        public RegexFSMCaptureStartTransitionDebugInfo(RegexFSMCaptureStartTransition<T> functionalTransition, params object[] args) : base(functionalTransition, args) { }
    }
    ...
    public class RegexFSMCaptureStartTransitionDebugInfo<T, TState> : RegexFSMFunctionalTransitionDebugInfoBase<T, RegexFSMCaptureStartTransition<T, TState>>
        where TState : IRegexFSMState<T>
    {
        ...
        /// <summary>
        /// 使用规范参数列表初始化 <see cref="RegexFSMCaptureStartTransitionDebugInfo{T, TState}"/> 类的新实例。
        /// </summary>
        /// <param name="functionalTransition">正则表达式构造的有限状态机的功能转换。</param>
        /// <param name="args">获取调试信息的参数列表。</param>
        public RegexFSMCaptureStartTransitionDebugInfo(RegexFSMCaptureStartTransition<T, TState> functionalTransition, params object[] args) : base(functionalTransition, args) { }
    }
}

...
namespace SamLu.RegularExpression.StateMachine
{
    ...
    public class BasicRegexNFA<T> : RegexFSM<T, BasicRegexNFAState<T>, BasicRegexFATransition<T, BasicRegexNFAState<T>>>, INFA<BasicRegexNFAState<T>, BasicRegexFATransition<T, BasicRegexNFAState<T>>, BasicRegexNFAEpsilonTransition<T>>
    {
        /// <summary>
        ...
        bool INFA.AttachTransition(IState state, IEpsilonTransition epsilonTransition) => this.AttachTransition((BasicRegexNFAState<T>)state, (BasicRegexFATransition<T, BasicRegexNFAState<T>>)epsilonTransition);

        bool INFA.RemoveTransition(IState state, IEpsilonTransition epsilonTransition) => this.RemoveTransition((BasicRegexNFAState<T>)state, (BasicRegexFATransition<T, BasicRegexNFAState<T>>)epsilonTransition);
        #endregion
    }
}

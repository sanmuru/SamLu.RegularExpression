...
{
    public sealed class RegexNegativeCaptureTransition<T> : FSMTransition, IRegexFunctionalTransition<T>
    {
        /// <summary>
        /// 获取 <see cref="RegexNegativeCaptureTransition{T}"/> 指向的状态。
        /// </summary>
    ...
    public sealed class RegexNegativeCaptureTransition<T, TState> : FSMTransition<TState>, IRegexFunctionalTransition<T, TState>

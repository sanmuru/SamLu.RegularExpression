...
{
    public sealed class RegexCaptureEndTransition<T> : FSMTransition, IRegexFunctionalTransition<T>
    {
        ...
        /// <summary>
        /// 获取 <see cref="RegexCaptureEndTransition{T}"/> 指向的状态。
        /// </summary>
    ...
    public sealed class RegexCaptureEndTransition<T, TState> : FSMTransition<TState>, IRegexFunctionalTransition<T, TState>

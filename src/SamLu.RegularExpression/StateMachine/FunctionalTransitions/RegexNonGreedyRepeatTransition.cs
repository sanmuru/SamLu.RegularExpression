...
{
    public sealed class RegexNonGreedyRepeatTransition<T> : FSMTransition, IRegexFunctionalTransition<T>
    {
        /// <summary>
        /// 获取 <see cref="RegexNonGreedyRepeatTransition{T}"/> 指向的状态。
        /// </summary>
    ...
    public sealed class RegexNonGreedyRepeatTransition<T, TState> : FSMTransition<TState>, IRegexFunctionalTransition<T, TState>

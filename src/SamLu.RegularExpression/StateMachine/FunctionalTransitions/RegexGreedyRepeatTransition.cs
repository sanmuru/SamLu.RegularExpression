...
{
    public sealed class RegexGreedyRepeatTransition<T> : FSMTransition, IRegexFunctionalTransition<T>
    {
        /// <summary>
        /// 获取 <see cref="RegexGreedyRepeatTransition{T}"/> 指向的状态。
        /// </summary>
    ...
    public sealed class RegexGreedyRepeatTransition<T, TState> : FSMTransition<TState>, IRegexFunctionalTransition<T, TState>
